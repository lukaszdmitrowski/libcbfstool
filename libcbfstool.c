...
int start_cbfs(int param_count, char **params)
{
	size_t i;
        int c;
        ...
        param.region_name = SECTION_NAME_PRIMARY_CBFS;
	...
	for (i = 0; i < ARRAY_SIZE(commands); i++) {
		...
		while (1) {
			...
			int option_index = 0;
                        ...
                        c = getopt_long(param_count, params, commands[i].optstring,
